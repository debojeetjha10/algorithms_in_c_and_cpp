...
//Top-Down Approach
int magic_grid1(int **input,int n, int m)
{
	int **dp=new int*[n];
	for(int i=0; i<n; i++)
	{
...
void solve()
{
	...
	int ans1=magic_grid1(input,n,m);
	int ans2=magic_grid2(input,0,0,n-1,m-1);
	cout<<ans1<<endl;
	cout<<ans2<<endl;
